                                    ...
                                    <asp:GridView ID="GvDatos" class="table table-striped table-bordered" Width="100%" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:CommandField ButtonType="Image" HeaderText="SELECT"
                                              ...
                                              <asp:BoundField DataField="viajeId" HeaderText="viajeId"
                                                Visible="false" />
                                            <asp:BoundField DataField="viajeOrigen" HeaderText="Origen">
                                                <FooterStyle HorizontalAlign="Center" />
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                             <asp:BoundField DataField="viajeDestino" HeaderText="Destino">
                                                <FooterStyle HorizontalAlign="Center" />
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="viajeTiempo" HeaderText="Duracion de viaje">
                                                <FooterStyle HorizontalAlign="Center" />
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="viajeHora" HeaderText="Hora salida">
                                                <FooterStyle HorizontalAlign="Center" />
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            ...
                                            <asp:BoundField DataField="personaId" HeaderText="Pasajero ID">
                                                <FooterStyle HorizontalAlign="Center" />
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
